...
registerPlugin( 'page-sidebar-team-title', {
  icon: 'id',
  render: () => {
    ...
    return (
      <div>
        <PluginDocumentSettingPanel
          name="page-sidebar-team-title"
          title={__('Team Member - Additional Fields', 'textdomain')}
					className="page-sidebar-team-title"
        >
          <PluginMetaFieldsText
            fieldLabel="Job Title"
			fieldName="team-title"
			fieldHelp="Leave blank if should not be displayed."
          />
		  <PluginMetaFieldsText
            fieldLabel="Linked in URL"
			fieldName="linkedin-href"
			fieldHelp="Leave blank if should not be displayed."
          />
		  <PluginMetaFieldsTextArea
            fieldLabel="Quote"
			fieldName="team-member-quote"
			fieldHelp="Only displays in listing when option is selected."
          />
