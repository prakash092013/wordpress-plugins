...
registerBlockType( 'cgb/carousel', {
	...
	edit: withSelect( function( select ) {
        ...
        return {
            posts: select( 'core' ).getEntityRecords( 'taxonomy', 'carousel', query  )
        };
    } )( function( props ) {
        ...
        const { attributes: { term, align, interval, height, heightxl, heightlg, heightmd, heightsm, heightxs }, setAttributes, className } = props;
        ...
        return (
        	<Fragment>
        		...
        		<Placeholder icon={ <BlockIcon icon="screenoptions" showColors /> } label="Carousel" className={className}>
					<PanelBody>
						<SelectControl
							label="Select Carousel"
							value={ term }
