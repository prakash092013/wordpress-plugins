	...
	class Testimonial_Custom_Post_Type {
        ...
        public function testimonial_post_type() {
			...
			$args = array(
				...
				'supports'      	 => array( 'title', 'editor', 'page-attributes' /*'excerpt',  'thumbnail',  'page-attributes'*/  ),
				'slug' 				 => 'testimonial',
				'has_archive'   	 => true,
				'hierarchical'   	 => false,
			...
			wp_insert_term(
				'Testimonial Carousel',   // the term 
				'testimonial-category', // the taxonomy
				array(
					'description' => 'A collection of testimonials from our customers and partners.',
	...
	$carouselOutput .= '<div class="carousel-inner ">';
		if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post();
			...
			$carouselOutput .= '<div class="carousel-item '. $activeclass . $addItemClass .'" role="tabpanel" id="tabpanel-'.$term.'-'.$counter.'" aria-labelledby="tab-'.$term.'-'.$counter.'">';
				...
				//$carouselOutput .= '<div class="carousel-caption">';
					if ($content){
